<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Stock.aspx.cs" Inherits="Take_Time_BangPhra.Product.Stock" %>
     ...
     <tr>
         ...
         <td style=width:80%>
             ...
             <asp:TextBox ID="TextBox1" runat="server" Width="50%" autocomplete="off"></asp:TextBox>
                  &nbsp; 
                  <button id="btnScanBarcode" runat="server" class="btn btn-success" style="width:30%;text-align:center" type="button">
                      Scan Barcode
                  </button>
...
<!-- This is where the camera feed will appear -->
     ...
     <tr>
         <td style=width:20% class="text-right">
             ราคาต่อชิ้น: </td>
         <td style=width:80%>
             <asp:TextBox ID="TextBox3" runat="server" Width="50%" Text="0"></asp:TextBox>
                  </td>
     ...
     <tr>
         <td style=width:20% class="text-right">
             หมายเหตุ: </td>
         <td style=width:80%>
             <asp:TextBox ID="TextBox4" runat="server" Width="50%" Text=""></asp:TextBox>
                  </td>
